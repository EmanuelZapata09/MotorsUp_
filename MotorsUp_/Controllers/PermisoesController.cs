...
namespace MotorsUp_.Controllers
{
    public class PermisoesController : Controller
    {
        ...
        public PermisoesController(tallerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Permisos != null ? 
                          ...
                          Problem("Entity set 'tallerContext.Permisos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPermiso,Nombre,Enlace")] Permiso permiso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPermiso,Nombre,Enlace")] Permiso permiso)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'tallerContext.Permisos'  is null.");
            }
            var permiso = await _context.Permisos.FindAsync(id);
            if (permiso != null)
            {
