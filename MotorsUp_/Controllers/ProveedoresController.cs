...
namespace MotorsUp_.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(tallerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Proveedores != null ? 
                          ...
                          Problem("Entity set 'tallerContext.Proveedores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,NombreProveedor,CorreoProveedor,DireccionProveedor,TelefonoProveedor,Estado")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProveedor,NombreProveedor,CorreoProveedor,DireccionProveedor,TelefonoProveedor,Estado")] Proveedore proveedore)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'tallerContext.Proveedores'  is null.");
            }
            var proveedore = await _context.Proveedores.FindAsync(id);
            if (proveedore != null)
            {
